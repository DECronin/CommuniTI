...
function CommentForm() {
    ...
    function renderResourcesList() {
        ...
        if (data.length > 0){
            data.forEach(el => {
                resourcesArray.push(<li className="single-resource-wrapper" key={data.indexOf(el)}>
                    ...
                    <div className="row res-body">
                        <div className="row">
                            ...
                            <div className="col-3">Released: {el.releaseDate}</div>
                        </div>
                        <div className="row">
    ...
    // useEffect(() =>{
    //     renderResourcesList()
    // }, [activeComponents.dataResourceInputs])
